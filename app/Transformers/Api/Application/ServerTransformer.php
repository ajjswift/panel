...
class ServerTransformer extends BaseTransformer
{
    ...
    public function transform(Server $server): array
    {
        return [
            ...
            'dns_service_profile_id' => $server->dns_service_profile_id,
            'subdomain_domain_restrictions' => $server->subdomain_domain_restrictions,
            'subdomain_policy_source' => $server->subdomain_policy_source,
            'subdomain_admin_notes' => $server->subdomain_admin_notes,
