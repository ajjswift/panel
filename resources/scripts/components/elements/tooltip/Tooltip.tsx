                ...
                {open && (
                    <motion.div
                        ...
                        {...getFloatingProps({
                            ref: floating,
                            className:
                                'bg-surface-elevated text-sm text-body border border-line shadow-md px-3 py-1.5 rounded-md pointer-events-none max-w-[24rem] z-50',
                            style: {
                                position: strategy,
                                top: `${y || 0}px`,
                                left: `${x || 0}px`,
                    ...
                    >
                        ...
                        {props.arrow && (
                            <div
                                ...
                                className={classNames('absolute bg-surface-elevated w-3 h-3', side)}
                            />
                        )}
                    </motion.div>
                )}
